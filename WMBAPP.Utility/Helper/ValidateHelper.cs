...
namespace Bill.Utility.Helper
{
    public class ValidateHelper
    {
        ...
        /// <returns></returns>
        public static bool IsMobileNumber(string mobileNo)
        {
            string pattern = @"(1[3,5,7,8][0-9])\d{8}$";
            return RegexHelper.IsMatch(mobileNo, pattern);
        }
        ...
        public static bool IsChinese(string str)
        {
            ...
            {
                result = RegexHelper.IsMatch(str.Substring(i,1), @"[\u4e00-\u9fa5]");
                if (result)
                    break;
            }
            return result;
        ...
        public static bool IsRussian(string str)
        {
            ...
            for (int i = 0; i < str.Length; i++)
            {
                result = RegexHelper.IsMatch(str.Substring(i, 1), @"[\u0400-\u052F]");
                if (result)
                    break;
            }
            return result;
